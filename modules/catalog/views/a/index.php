            ...
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <td class="control">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <?php if(IS_ROOT) : ?>
                        <a href="/admin/catalog/a/fields/<?= $item->primaryKey ?>" class="btn btn-default" title="<?= Yii::t('easyii/catalog', 'Manage fields') ?>"><span class="glyphicon glyphicon-cog"></span></a>
