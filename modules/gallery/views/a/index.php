    ...
    <table class="table table-hover">
        ...
        <?php foreach($data->models as $item) : ?>
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <?php endif; ?>
                <td><a href="<?= Url::to(['/admin/'.$module.'/a/photos', 'id' => $item->primaryKey]) ?>"><?= $item->title ?></a></td>
                <td><?= $item->photo_count ?></td>
                <td class="status">
                    <?= Html::checkbox('', $item->status == Album::STATUS_ON, [
                        'class' => 'switch',
                        'data-id' => $item->primaryKey,
                        'data-link' => '/admin/'.$module.'/a'
                    ]) ?>
                </td>
                <td class="control">
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <a href="<?= Url::to(['/admin/'.$module.'/a/edit', 'id' => $item->primaryKey]) ?>" class="btn btn-default" title="<?= Yii::t('easyii', 'Edit category') ?>"><span class="glyphicon glyphicon-pencil"></span></a>
