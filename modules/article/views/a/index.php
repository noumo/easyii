        ...
        <td width="120" class="text-right">
            <div class="dropdown actions">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownMenu'.$node['category_id'].'">
                    ...
                    <li role="presentation" class="divider"></li>
                    <li><a href="' . Url::to(['/admin/article/a/delete', 'id' => $node['category_id']]) . '" class="confirm-delete" data-reload="1" title="'.Yii::t('easyii', 'Delete item').'"><i class="glyphicon glyphicon-remove font-12"></i> '.Yii::t('easyii', 'Delete').'</a></li>
                </ul>
            </div>
        </td>
    ';
